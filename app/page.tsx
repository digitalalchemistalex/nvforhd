...
export default function HomePage() {
  return (
    <>
      ...
      <section style={{ position: 'relative', height: '100vh', minHeight: '720px', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', background: 'var(--void)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1440px', margin: '0 auto', padding: '0 5rem 7rem', width: '100%' }}>
          ...
          <p style={{ fontSize: '1.05rem', fontWeight: 300, lineHeight: 1.9, color: 'rgba(245,242,234,0.82)', maxWidth: '500px', marginBottom: '3.5rem', borderLeft: '2px solid var(--gold)', paddingLeft: '1.5rem', animation: 'fadeup 0.9s var(--ease) 0.95s both' }}>
            Sean Schaeffer&apos;s wife Christine was diagnosed with Huntington&apos;s Disease. He didn&apos;t hold a fundraiser.<br />
          ...
          <div style={{ animation: 'fadeup 0.9s var(--ease) 1.1s both' }}>
            <div style={{ fontSize: '0.65rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(245,242,234,0.52)', marginBottom: '1.2rem', fontWeight: 500 }}>Make a donation — choose an amount</div>
            ...
            <a href={GOLF} target="_blank" rel="noopener" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(245,242,234,0.45)', textDecoration: 'none' }}>
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8rem', alignItems: 'start', position: 'relative' }}>
          <ScrollReveal>
            ...
            <p style={{ fontSize: '1.05rem', lineHeight: 1.95, color: 'rgba(245,242,234,0.78)', fontWeight: 300 }}>
              Every child of an HD parent has a <strong style={{ color: '#fff', fontWeight: 600 }}>50% chance of inheriting it.</strong> It doesn&apos;t just take one person — it haunts entire families across generations.
            </p>
          </ScrollReveal>
          <div>
            {[
              ...
              { n: '03', t: <><strong style={{color:'#fff',fontWeight:600}}>UC Davis HD Center of Excellence</strong> is the only specialty clinic serving Northern Nevada&apos;s 90+ HD families. It operates entirely on private donation.</> },
              { n: '04', t: <><strong style={{color:'#fff',fontWeight:600}}>Your donation breaks the cycle.</strong> One donation funded IVF so the Puccini family&apos;s child will never carry this disease. Rylee is now pregnant.</> },
            ].map(({ n, t }, i) => (
      ...
      {/* ══ SPONSORS — real logos, tiered visual design ══ */}
      <SponsorsSection />
