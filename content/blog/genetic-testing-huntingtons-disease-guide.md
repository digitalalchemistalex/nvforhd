...
author: "NVforHD"
category: "Education"
coverImage: "/images/hero-couple.jpg"
coverAlt: "A couple facing the genetic testing decision for Huntington's Disease"
readingTime: 7
featured: false
---
...
:::stats-grid
:::stat 50% | Chance of inheriting HD from an affected parent
:::stat 5–10% | Of at-risk adults choose to undergo predictive testing
:::stat 95%+ | Accuracy of PGT-M in identifying HD-free embryos
:::end
...
:::fact The HTT gene CAG repeat test is highly accurate. There are no false positives for counts of 40 or above. The genetic mutation is the disease — its presence guarantees development. Source: HDSA Medical Advisory Board
...
:::warning Some people have undergone predictive testing through direct-to-consumer tests without counseling support. This is dangerous. A positive result delivered without context or support has caused severe psychological harm. Always test through a clinical setting with a genetic counselor.

:::pull "The decision to learn your genetic status is irreversible. You cannot unknow what you know. That is not a reason not to test — but it is a reason to test thoughtfully."
...
:::fact Non-disclosure testing is available at specialist HD genetic centers including HDSA Centers of Excellence. It requires careful coordination with the genetics team. Source: HDSA Genetic Testing Protocol
...
With IVF and PGT-M:
1. Eggs are retrieved and fertilised in a lab
2. Embryos are tested for the HD gene mutation
3. Only HD-free embryos are transferred
4. The child born from this process will not have HD and cannot pass it to their own children

:::image /images/baby-hands.jpg | Baby hands — the next generation can be free of Huntington's Disease | IVF with PGT-M means the HD cycle ends here

**The result:** The HD mutation stops with your generation. Your children and grandchildren will never face this choice.

:::fact IVF with PGT-M has a success rate above 95% for identifying HD-free embryos. The procedure is FDA-cleared and is available at fertility centers that offer preimplantation genetic testing. Source: HDSA

**The barrier:** Cost. A full IVF cycle with PGT-M typically costs $15,000–$25,000, and insurance coverage is inconsistent.

This is precisely the barrier that NVforHD's 2024 charity partner HelpCureHD was built to remove. They provide grants to HD families who cannot afford IVF. [Read how $25,000 from our golf tournament funded the Puccini family's IVF journey](/blog/ivf-genetic-testing-huntingtons-disease).
...
[Learn more about what NVforHD funds at UC Davis](/causes).
...
:::pull "The genetic counselor's job is not to push you toward testing. It is to make sure that whatever you decide, you decide it with full information and genuine support."
...
📞 775-691-8860 · [Contact us here](/contact)
