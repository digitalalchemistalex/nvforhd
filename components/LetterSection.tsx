...
// Couple holding ultrasound photo — mirrors the Puccini letter exactly
  ...
  return (
    <section id="letter" style={{ background: 'var(--void)', position: 'relative' }}>
      ...
      <img
        ...
        loading="lazy"
        style={{ width: '100%', height: '80vh', minHeight: '540px', objectFit: 'cover', objectPosition: 'center 35%', filter: 'sepia(15%) brightness(0.58) contrast(1.1) saturate(0.9)', display: 'block' }}
      />
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '8rem 5rem 5.5rem', background: 'linear-gradient(to top, rgba(5,6,10,1) 52%, rgba(5,6,10,0.82) 75%, rgba(5,6,10,0.2) 92%, transparent)' }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8rem', alignItems: 'end' }}>
          <ScrollReveal>
            ...
            <div style={{ fontFamily: 'var(--serif)', fontWeight: 300, lineHeight: 0.9, color: '#FFFFFF', fontSize: 'clamp(2.8rem,5.5vw,6.5rem)', letterSpacing: '-0.02em', textShadow: '0 4px 40px rgba(0,0,0,0.5)' }}>
          ...
          <ScrollReveal delay={0.2}>
            ...
            <div style={{ padding: '2.5rem', border: '1px solid rgba(201,168,76,0.28)', background: 'rgba(5,6,10,0.85)', backdropFilter: 'blur(16px)' }}>
              ...
              <p style={{ fontSize: '0.88rem', color: 'rgba(245,242,234,0.68)', fontWeight: 300, marginBottom: '1.8rem', lineHeight: 1.75 }}>No golf required. Your donation funds IVF for the next family carrying the HD gene. $150 makes a direct difference.</p>
